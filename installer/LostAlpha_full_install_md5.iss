...
[Components]
Name: "LA"; Description: "Lost Alpha components"; Types: full custom; Flags: fixed
;///////////////////////////////////////////////
Name: "extra\EE"; Description: "Extended edition (director's cut)"; Types: full custom
Name: "extra\Sidorovich"; Description: "Sidorovich from CS (Clear sky)"; Types: full custom
Name: "extra\Killer"; Description: "Classic actor killer (SOC)"; Types: full custom
Name: "extra\Spawn"; Description: "New xrai spawn"; Types: full custom
Name: "appdata"; Description: "Enable color boost for DX9 (user_boost.ltx)"; Types: full custom
;///////////////////////////////////////////////
...
Source: "{#LA_game_files}\Mods\*"; DestDir: "{app}\Mods"; Flags: ignoreversion createallsubdirs recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\*.bat"; DestDir: "{app}"; Flags: ignoreversion createallsubdirs recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\gamedata.db*"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "{tmp}\extra\EE\gamedata.dbp"; DestDir: "{app}"; Components: extra\EE
Source: "{tmp}\extra\Sidorovich\gamedata.dbr"; DestDir: "{app}"; Components: extra\Sidorovich
Source: "{tmp}\extra\Killer\gamedata.dbu"; DestDir: "{app}"; Components: extra\Killer
Source: "{tmp}\extra\Spawn\gamedata.dbo"; DestDir: "{app}"; Components: extra\Spawn
Source: "{tmp}\appdata\*"; DestDir: "{app}\appdata"; Components: appdata
Source: "{tmp}\menu_boost.bat"; DestDir: "{app}"; Components: appdata
Source: "{#LA_game_files}\fsgame.ltx"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
...
Source: "{#LA_game_files}\changelog_14005.txt"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "{#LA_game_files}\changelog_en_14005.txt"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "{#LA_game_files}\readme.txt"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
;Source: "{#LA_game_files}\*"; DestDir: "{app}"; Flags: ignoreversion createallsubdirs recursesubdirs skipifsourcedoesntexist

Source: "{#LA_game_files}\3rdparties\oalinst.exe"; DestDir: "{app}\3rdparties"; Flags: skipifsourcedoesntexist ignoreversion
Source: "{#LA_game_files}\3rdparties\vcredist_x86.exe"; DestDir: "{app}\3rdparties"; Flags: skipifsourcedoesntexist ignoreversion
Source: "{#LA_game_files}\3rdparties\Xvid-1.3.2-20110601.exe"; DestDir: "{app}\3rdparties"; Flags: skipifsourcedoesntexist ignoreversion
Source: "{#LA_game_files}\3rdparties\DirectX\*"; DestDir: "{app}\3rdparties\DirectX"; Flags: skipifsourcedoesntexist ignoreversion createallsubdirs recursesubdirs
#endif
...
Type: files; Name: "{app}\gamedata\levels\ai_test.db0";
Type: files; Name: "{app}\gamedata\levels\factory_test.db1";
Type: files; Name: "{app}\gamedata\levels\la01_escape.db0";
Type: files; Name: "{app}\gamedata\levels\la02_garbage.db0";
Type: files; Name: "{app}\gamedata\levels\la03_agroprom.db0";
Type: files; Name: "{app}\gamedata\levels\la04_darkdolina.db0";
Type: files; Name: "{app}\gamedata\levels\la04u_darklab.db0";
Type: files; Name: "{app}\gamedata\levels\la05_bar_rostok.db0";
Type: files; Name: "{app}\gamedata\levels\la06_yantar.db0";
Type: files; Name: "{app}\gamedata\levels\la07_military.db0";
Type: files; Name: "{app}\gamedata\levels\la08_deadcity.db1";
Type: files; Name: "{app}\gamedata\levels\la09_swamp.db0";
Type: files; Name: "{app}\gamedata\levels\la10_radar.db0";
Type: files; Name: "{app}\gamedata\levels\la10u_bunker.db0";
Type: files; Name: "{app}\gamedata\levels\la11_pripyat.db0";
Type: files; Name: "{app}\gamedata\levels\la12_stancia.db0";
Type: files; Name: "{app}\gamedata\levels\la12u_sarcofag.db0";
Type: files; Name: "{app}\gamedata\levels\la13_generators.db0";
Type: files; Name: "{app}\gamedata\levels\la13u_oso.db0";
Type: files; Name: "{app}\gamedata\levels\la13u_warlab.db1";
Type: files; Name: "{app}\gamedata\levels\la14_rostok_factory.db0";
Type: files; Name: "{app}\gamedata\levels\la14u_secret_lab.db0";
Type: files; Name: "{app}\gamedata\levels\la15_darkscape.db0";
Type: files; Name: "{app}\gamedata\levels\la16_lost_factory.db0";
Type: files; Name: "{app}\gamedata\levels\la16u_labx16.db0";
Type: files; Name: "{app}\gamedata\levels\la17_outskirts.db0";
Type: files; Name: "{app}\gamedata\levels\la17u_labx7.db0";
Type: files; Name: "{app}\gamedata\levels\la18_damned.db0";
Type: files; Name: "{app}\gamedata\levels\la19_country.db1";
Type: files; Name: "{app}\gamedata\levels\la20_forgotten.db0";
Type: files; Name: "{app}\gamedata\levels\la21_generators_2.db0";
Type: files; Name: "{app}\gamedata\levels\la22_forest.db0";
Type: files; Name: "{app}\gamedata\levels\la23_oldroad.db0";
Type: files; Name: "{app}\gamedata\levels\la24_antennas.db0";

Type: files; Name: "{app}\gamedata\anims.db0";
Type: files; Name: "{app}\gamedata\levels.db0";
Type: files; Name: "{app}\gamedata\levels.db1";
Type: files; Name: "{app}\gamedata\meshes.db0";
Type: files; Name: "{app}\gamedata\shaders.db0";
Type: files; Name: "{app}\gamedata\sounds.db0";
Type: files; Name: "{app}\gamedata\sounds.db1";
Type: files; Name: "{app}\gamedata\spawns.db0";
Type: files; Name: "{app}\gamedata\textures.db0";
Type: files; Name: "{app}\gamedata\textures.db1";
Type: files; Name: "{app}\gamedata\textures.db2";
Type: files; Name: "{app}\gamedata\textures.db3";
Type: files; Name: "{app}\gamedata\textures.db4";
Type: files; Name: "{app}\gamedata\textures.db5";
...
Type: files; Name: "{app}\menu.bat"
Type: files; Name: "{app}\menu_boost.bat"
...
begin
  if MsgBox(ExpandConstant('{cm:WipeUser}'), mbConfirmation, MB_YESNO or MB_DEFBUTTON1) = IDYES
  then
    begin
