...
Source: "{#LA_game_files}\mods\gameplay_dlc.xdb"; Components: adgame; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\gameplay_dlc_readme_en.txt"; Components: adgame; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\gameplay_dlc_readme_ru.txt"; Components: adgame; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\mods\gameplay_dlc_prm_weapons_dlc.xdb"; Components: adgameweapon; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\gameplay_dlc_readme_en.txt"; Components: adgameweapon; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\gameplay_dlc_readme_ru.txt"; Components: adgameweapon; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\prm_weapons_readme_en.txt"; Components: adgameweapon; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\prm_weapons_readme_ru.txt"; Components: adgameweapon; DestDir: "{app}"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\mods\new_npc.xdb"; Components: new_npc; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\mods\new_npc2.xdb"; Components: new_npc\new_npc2; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\mods\autumn.xdb"; Components: autumn; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
Source: "{#LA_game_files}\mods\la_rus_voice.xdb"; Components: la_rus_voice; DestDir: "{app}\mods"; Flags: ignoreversion recursesubdirs skipifsourcedoesntexist
#endif
...
[Components]
Name: adgame; Description: Advanced Gameplay; Types: full custom; Flags: exclusive;
Name: adgameweapon; Description: Advanced Gameplay + PMR Weapon Pack; Types: full custom; Flags: exclusive;
Name: new_npc; Description: New NPC meshes; Types: full custom;
Name: new_npc\new_npc2; Description: : Alternative meshes of mercenaries; Types: full custom;
Name: autumn; Description: Autumn Pack; Types: full custom;
Name: la_rus_voice; Description: Russian voice; Types: full custom;
...
[Icons]
;Name: "{group}\{#LA_shortcut_name}"; Filename: "{app}\bins\XR_3DA.exe"; WorkingDir: "{app}"; Parameters: "-external -noprefetch -nospawncheck"
;Name: "{commondesktop}\{#LA_shortcut_name}"; Filename: "{app}\bins\XR_3DA.exe"; WorkingDir: "{app}"; Parameters: "-external -noprefetch -nospawncheck"

[Registry]
Root: HKLM; Subkey: "SOFTWARE\GSC Game World\STALKER-LADC\ver1.4005-ext-0.1"; Flags: createvalueifdoesntexist uninsdeletekey;
...
begin
  ...
  with MD5Form do begin
    ...
    Center;
        ...
        begin
Result:=True;
If (not RegKeyExists(HKLM, 'SOFTWARE\GSC Game World\STALKER-LADC\ver1.4005-0.0')) then
begin
MsgBox('Установленная полная версия игры S.T.A.L.K.E.R. - Lost Alpha DC 1.4005 не найдена.' #13#13 'Для установки Extended pack следует установить ее.', mbError, mb_Ok);
Result:=False;
end;
