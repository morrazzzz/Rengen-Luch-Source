...
void CPHElement::SetGravity_K(float K)
{ 
	dBodySetGravityK(m_body, K); 
}

float CPHElement::GetGravity_K()
{ 
	return dBodyGetGravityK(m_body); 
}
...
void CPHElement::GetPointVel( Fvector	 &res_vel, const Fvector & point ) const
{
 ...
 void CPHElement::InverceLocalForm(Fmatrix& m)
{
	m.identity();
 ...
 void CPHElement::MulB43InverceLocalForm(Fmatrix& m) const
{
