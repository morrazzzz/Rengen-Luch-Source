...
@setlocal
@set LJCOMPILE=cl /nologo /MP /Zi /c /O2 /W3 /fp:precise /GF /GS- /D_CRT_SECURE_NO_DEPRECATE
...
%LJLINK% /DEBUG /out:minilua.exe minilua.obj
@if errorlevel 1 goto :BAD
...
@if errorlevel 1 goto :BAD
%LJLINK% /DEBUG /out:buildvm.exe buildvm*.obj
@if errorlevel 1 goto :BAD
...
@if errorlevel 1 goto :BAD
%LJLINK% /DEBUG /DLL /out:%LJDLLNAME% lj_*.obj lib_*.obj xr_*.obj
@if errorlevel 1 goto :BAD
@goto :MTDLL
:STATIC
