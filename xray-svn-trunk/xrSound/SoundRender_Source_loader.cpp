...
#ifndef __BORLANDC__
	AccessLock sound_creation_protect;
#endif
...
#ifdef SUPER_DEBUG
		R_ASSERT2(false, make_string("! Can't find sound '%s'. Creating default sound", fn));
#endif

		FS.update_path(fn, "$game_sounds$", "$no_sound.ogg");
	
		R_ASSERT2(FS.exist(fn), make_string("! Can't find default sound '%s', this is bad", fn));
    }
