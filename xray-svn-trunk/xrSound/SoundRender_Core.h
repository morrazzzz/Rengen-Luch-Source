...
public:
	...
	virtual BOOL						i_locked				()					{ bLockedProtect_.Enter(); BOOL res = bLocked; bLockedProtect_.Leave(); return res; }
	virtual void						set_locked				(BOOL val = TRUE)	{ bLockedProtect_.Enter(); bLocked = val; bLockedProtect_.Leave(); }
