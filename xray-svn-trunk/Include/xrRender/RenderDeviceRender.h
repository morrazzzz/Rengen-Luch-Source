...
public:
	...
	virtual void	ResourcesDeferredUpload(BOOL multithreaded) = 0;
	virtual void	SyncTexturesLoadingProcess() = 0;
	...
	virtual void	RenderBegin(ViewPort vp) = 0;
	virtual void	Clear() = 0;
	virtual void	RenderFinish(ViewPort vp) = 0;
	virtual void	ClearTarget() = 0;
	virtual void	SetCacheXform(Fmatrix &mView, Fmatrix &mProject) = 0;
	virtual void	OnAssetsChanged() = 0;
	virtual void	OnNewFrame() = 0;

	virtual void	SwitchViewPortRTZB(ViewPort vp) = 0;
