...
#ifndef _EDITOR
#include <mutex>
#include "..\xr_3da\xrRender\KinematicsAddBoneTransform.hpp"
#endif
...
public:
#ifndef _EDITOR
	std::recursive_mutex protectKinematics_;
#else
...
virtual	const IBoneData&		_BCL	GetBoneData					(u16 bone_id) const = 0;
...
#ifndef _EDITOR
	virtual void						CalculateBones				(BonesCalcType calc_type = can_optimize) = 0; // Recalculate skeleton
#else
	...
	virtual void						NeedToCalcBones				(bool exact = false) = 0; // Assign me for bones update
