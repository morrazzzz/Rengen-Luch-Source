...
public:
    ...
    virtual void __stdcall DrawSnowFlake		(const Fvector& p, float radius, u32 clr)=0;
	...
	virtual void __stdcall DrawSphere		   	(const Fmatrix& parent, const Fvector& center, float radius, u32 clr_s, u32 clr_w, BOOL bSolid, BOOL bWire, bool mul_by_parent_M = true)=0;
