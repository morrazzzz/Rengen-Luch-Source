...
extern "C" void dDebug (int num, const char *msg, ...)
{
  ...
  MessageBox(NULL, "Abort called in xrODE error.cpp", "Debug the Error", MB_OK | MB_ICONWARNING | MB_TASKMODAL);
...
void _cdecl dDebug (int num, const char *msg, ...)
{
  ...
  MessageBox(NULL, "xrODE error.cpp 2", "Abort called", MB_OK | MB_ICONWARNING | MB_TASKMODAL);
