...
#	endif
		...
		for (b = 0; b < nb; b++)
		{
			...
			{
				body->facc[0] = saveFacc[b * 4 + 0] + body->mass.mass * world->gravity[0] * body->gravity_K;
				body->facc[1] = saveFacc[b * 4 + 1] + body->mass.mass * world->gravity[1] * body->gravity_K;
				body->facc[2] = saveFacc[b * 4 + 2] + body->mass.mass * world->gravity[2] * body->gravity_K;
				body->facc[3] = 0;
			}
