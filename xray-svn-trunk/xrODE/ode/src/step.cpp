...
# endif
  ...
  for (i=0; i<nb; i++) {
    if ((body[i]->flags & dxBodyNoGravity)==0) {
		body[i]->facc[0] += body[i]->mass.mass * world->gravity[0] * body[i]->gravity_K;
		body[i]->facc[1] += body[i]->mass.mass * world->gravity[1] * body[i]->gravity_K;
		body[i]->facc[2] += body[i]->mass.mass * world->gravity[2] * body[i]->gravity_K;
    }
  }
