...
//------------------------------------------------------------------------------
#include "../Ecore/EditorRender/shader.h"
...
#include "../Ecore/EditorRender/PSLibrary.h"
...
void __fastcall TfrmMain::OnMouseWheel(TObject *Sender, TShiftState Shift,
	int WheelDelta, TPoint &MousePos, bool &Handled)
{
	UI->MouseWheel(Shift, WheelDelta, MousePos);
}
//---------------------------------------------------------------------------

void __fastcall TfrmMain::OnMouseWheelDown(TObject *Sender,
	TShiftState Shift, TPoint &MousePos, bool &Handled)
{
	UI->MouseWheelDown(Shift, MousePos);
}
//---------------------------------------------------------------------------

void __fastcall TfrmMain::OnMouseWheelUp(TObject *Sender,
	TShiftState Shift, TPoint &MousePos, bool &Handled)
{
	UI->MouseWheelUp(Shift, MousePos);
}
//---------------------------------------------------------------------------
