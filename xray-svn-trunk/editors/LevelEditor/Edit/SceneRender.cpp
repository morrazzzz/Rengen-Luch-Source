...
{\
    try{\
        ...
        R_ASSERT2(false, make_string("Please notify AlexMX!!! Critical error has occured in render routine!!! [Type B] - Tools: '%s' Object: '%s'", (N->val)->ParentTools->ClassName(), (N->val)->Name));\
    }\
}
	...
	{\
        ...
        for (; s_it!=s_end; s_it++){\
            ...
            try{\
		        ...
		        R_ASSERT2(false, make_string("Please notify AlexMX!!! Critical error has occured in render routine!!! [Type B] - Tools: '%s'", (*s_it)->ClassName()));\
            }\
        }\
    }
