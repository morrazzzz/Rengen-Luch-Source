...
class ECORE_API CCustomObject : public AxisManager
{
	ObjClassID		FClassID;
    ...
    void			AnimationUpdate		(float t, bool is_loading_in_progress = false);
public:
	enum{
    	flSelected					= (1<<0),
...
public:
    ...
    CCustomObject* 	GetOwner		(){return m_pOwnerObject;} //Owning Group
