...
{
	if (!E->m_Flags.is(CEditableObject::eoUsingLOD)){ Msg("! Object is not using LOD"); return -1;}
    ...
    mtl.shader_xrlc	= -1;
    if ((u16(-1)==mtl.surfidx)||(u16(-1)==mtl.shader)){ Msg("! LOD: Surface of shader problem"); return -2;}
