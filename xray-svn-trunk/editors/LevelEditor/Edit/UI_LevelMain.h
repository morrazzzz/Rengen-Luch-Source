...
enum {
	...
	COMMAND_RESET_OBJECT_ROT,
	COMMAND_RESET_OBJECT_SC,
};
//------------------------------------------------------------------------------
...
public:
    ...
    virtual void 	OutInfo					();
			void 	UpdateVertsFacesInfo	(u32 vertexes, u32 faces);
