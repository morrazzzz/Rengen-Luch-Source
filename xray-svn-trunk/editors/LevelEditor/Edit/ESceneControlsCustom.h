...
// self move
	bool ByAxisMoveStart	(TShiftState _Shift);
	bool ByAxisMoveEnd(TShiftState _Shift);
	void ByAxisMoveProcess(TShiftState _Shift);
...
//preview
	bool 				PreviewMStart		(TShiftState _Shift);
	void 				PreviewMMove		(TShiftState _Shift);
	bool 				PreviewMEnd			(TShiftState _Shift);
...
public:
	...
	virtual void 	ToolsMouseWheel  	(TShiftState _Shift);
	virtual void 	ToolsMouseWheelUp   (TShiftState _Shift);
	virtual void 	ToolsMouseWheelDown (TShiftState _Shift);
