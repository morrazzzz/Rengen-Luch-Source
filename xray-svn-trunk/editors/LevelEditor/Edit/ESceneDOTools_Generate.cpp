...
bool EDetailManager::Initialize()
{
	...
	if(objects.empty())
		ELog.DlgMsg(mtError,"Detail objects list is empty - to fix it - go to\nDetail object Edit mode->Detail Objects List and press 'Load' button.\nYou could also save oject list from other map and load it in your map");
