...
private:	// User declarations
	...
	bool GenerateLOD_Object(CEditableObject* e_object, bool bHighQuality);
...
public:		// User declarations
	...
	//Generates LODS that were reported while working in editor. 
	static void __fastcall	AutoGenerateLODS();
