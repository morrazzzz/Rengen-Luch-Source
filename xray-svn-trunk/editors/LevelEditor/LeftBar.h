...
__published:	// IDE-managed Components
	...
	TBevel *Bevel3;
        TMenuItem *miResetRotation;
        TMenuItem *N28;
        TMenuItem *miResetScaling;
        TMenuItem *miUndo2;
        TMenuItem *miRedo2;
	...
	void __fastcall ebResetObjectRotationClick(TObject *Sender);
	void __fastcall ebResetObjectScalingClick(TObject *Sender);
	...
	void __fastcall ebGenerateMisingLODS(TObject *Sender);
