...
void __fastcall TfraLeftBar::ebResetObjectRotationClick(TObject *Sender)
{
	ExecCommand( COMMAND_RESET_OBJECT_ROT );
}

void __fastcall TfraLeftBar::ebResetObjectScalingClick(TObject *Sender)
{
	ExecCommand( COMMAND_RESET_OBJECT_SC );
}
...
void __fastcall TfraLeftBar::ebGenerateMisingLODS(TObject *Sender)
{
	ExecCommand( COMMAND_GENERATE_MISING_LODS );
}
//---------------------------------------------------------------------------
