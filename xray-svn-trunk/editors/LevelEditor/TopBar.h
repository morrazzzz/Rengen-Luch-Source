...
__published:	// IDE-managed Components
	...
	TExtBtn *ebClearSelection;
	TExtBtn *ebClearSelectionAll;
	...
	void __fastcall ebClearSelectionClick(TObject *Sender);
	void __fastcall ebClearSelectionAllClick(TObject *Sender);
