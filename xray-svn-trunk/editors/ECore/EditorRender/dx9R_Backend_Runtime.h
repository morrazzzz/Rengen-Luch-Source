...
ICF void CBackend::BackendRender(D3DPRIMITIVETYPE T, u32 baseV, u32 startV, u32 countV, u32 startI, u32 PC)
{
	//Fix D3D ERROR
	if (PC==0)
		return;
...
ICF void CBackend::BackendRender(D3DPRIMITIVETYPE T, u32 startV, u32 PC)
{
	//Fix D3D ERROR
	if (PC==0)
		return;
