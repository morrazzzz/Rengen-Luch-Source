...
//sweetfx
float		ps_r3_vibrance				= 0.0f;
BOOL		ps_r3_technicolor			= FALSE;

//water reflectrions
BOOL		ps_r3_water_reflections			= TRUE;
BOOL		ps_r3_water_refl_obj			= FALSE;
BOOL		ps_r3_water_refl_moon			= TRUE;
float		ps_r3_water_refl_env_power		= 0.8f;
float		ps_r3_water_refl_intensity		= 2.5f;
float		ps_r3_water_refl_range			= 400.f;
...
BOOL		ps_r3_use_ss_sunshafts_blending		= 0;

float		ps_r3_ss_sunshafts_intensity		= 1.f;
float		ps_r3_ss_sunshafts_density		= 1.25f;
int			ps_r3_ss_sunshafts_quality		= 1;
float		ps_r3_ss_sunshafts_blend_f		= 1.f;

BOOL optimizeLightOccCalc_ = TRUE;
...
//	CMD3(CCC_Mask,		"r2_sun_static",		&ps_r2_ls_flags,			R2FLAG_SUN_STATIC);
	...
	CMD4(CCC_Integer,	"r__optimize_light_occ_calc",	&optimizeLightOccCalc_,		0, 1);
...
//Separate values for steep parallax
	...
	CMD3(CCC_Mask,		"r4_tess_wireframe",			&ps_r2_ls_flags_ext,		R2FLAGEXT_TESS_WIREFRAME);//Need restart //skyloader: for tessellation test
	...
	CMD4(CCC_Integer,	"r2_fxaa",						&ps_r2_fxaa,				0, 1		); // Radium mod FXAA
	...
	CMD4(CCC_Float,		"r3_vibrance",					&ps_r3_vibrance,			-1.0f,	1.0f);
	...
	CMD4(CCC_Integer,	"r3_use_ss_sunshafts_blending",	&ps_r3_use_ss_sunshafts_blending,		0, 1);

	CMD4(CCC_Float,		"r3_ss_sunshafts_intensity",	&ps_r3_ss_sunshafts_intensity,			0.1f,	2.f);
	CMD4(CCC_Float,		"r3_ss_sunshafts_density",		&ps_r3_ss_sunshafts_density,				0.1f,	2.f);
	CMD4(CCC_Integer,	"r3_ss_sunshafts_quality",		&ps_r3_ss_sunshafts_quality,				1, 3);
	CMD4(CCC_Float,		"r3_ss_sunshafts_blend_f",		&ps_r3_ss_sunshafts_blend_f,				0.1f,	2.f);
...
//	CMD3(CCC_Mask,		"r2_sun_ignore_portals",		&ps_r2_ls_flags,			R2FLAG_SUN_IGNORE_PORTALS);
	...
	// test
	CMD4(CCC_Float,		"r__test_shader_float_1",			&ps_r__test_exp_to_shaders_1, -10000, 10000);
	CMD4(CCC_Float,		"r__test_shader_float_2",			&ps_r__test_exp_to_shaders_2, -10000, 10000);
	CMD4(CCC_Float,		"r__test_shader_float_3",			&ps_r__test_exp_to_shaders_3, -10000, 10000);
	CMD4(CCC_Float,		"r__test_shader_float_4",			&ps_r__test_exp_to_shaders_4, -10000, 10000);
