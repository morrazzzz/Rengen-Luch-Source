...
void CDetailManager::hw_Render()
{
	...
	//float		tm_rot1		= (PI_MUL_2*EngineTime()/swing_current.rot1);
	//float		tm_rot2		= (PI_MUL_2*EngineTime()/swing_current.rot2);
	...
	Fvector4	wave;
	//wave.set				(1.f/5.f,		1.f/7.f,	1.f/3.f,	EngineTime() * swing_current.speed);
	...
	// Wave1
	//wave.set				(1.f/3.f,		1.f/7.f,	1.f/5.f,	EngineTime() * swing_current.speed);
