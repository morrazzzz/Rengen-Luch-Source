...
// mouse action
	...
	void __fastcall MouseWheel			(TShiftState Shift, int WheelDelta, TPoint &MousePos);
	void __fastcall MouseWheelUp		(TShiftState Shift, TPoint &MousePos);
	void __fastcall MouseWheelDown		(TShiftState Shift, TPoint &MousePos);
