...
public:
	...
	virtual void __fastcall 	MouseWheel		(TShiftState Shift){};
	virtual void __fastcall 	MouseWheelUp	(TShiftState Shift){};
	virtual void __fastcall 	MouseWheelDown	(TShiftState Shift){};
