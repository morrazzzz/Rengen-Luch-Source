...
void TUI::MouseWheel(TShiftState Shift, int WheelDelta, TPoint &MousePos)
{
	Tools->MouseWheel(m_ShiftState);
}

void TUI::MouseWheelUp(TShiftState Shift, TPoint &MousePos)
{
	Tools->MouseWheelUp(m_ShiftState);
}

void TUI::MouseWheelDown(TShiftState Shift, TPoint &MousePos)
{
	Tools->MouseWheelDown(m_ShiftState);
}
...
void TUI::Redraw()
{
	...
	try
	{
		...
		if (EDevice.Begin()){
			...
			{
				R_ASSERT2(false, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type B]");
			}
			...
			{
				R_ASSERT2(false, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type C]");
			}
		}
	...
	{
		R_ASSERT2(false, "Please notify AlexMX!!! Critical error has occured in render routine!!! [Type A]");
		//		_clear87();
		//		FPU::m24r();
