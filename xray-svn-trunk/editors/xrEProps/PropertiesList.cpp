...
void __fastcall TProperties::ColorClick(TElTreeItem* item)
{
    ...
    case PROP_VCOLOR:{
        ...
        u32 ev 				= C.get();
        if (ETOOLS::SelectColor(&ev, false))
		{
			VERIFY2(false, "Who ever sees this message - report to Rafa, if color picking for this option is correct");
        	C.set			(ev);
    ...
    case PROP_COLOR:{
        ...
        if (ETOOLS::SelectColor(&edit_val, true))
		{
