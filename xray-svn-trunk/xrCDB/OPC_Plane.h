...
#define __ICEPLANE_H__
	...
	class ICEMATHS_API Plane
	{
		...
		inline_	Plane&	Set(float nx, float ny, float nz, float dd)						{ n.Set(nx, ny, nz); d = dd;		return *this;	}
		inline_	Plane&	Set(const Point& p, const Point& nn)							{ n = nn; d = - p | nn;				return *this;	}
