...
public:
	...
	Self(Tvector t, Tvector tt)
	{
		min = t;
		max = tt;
	};

	Self(T X1, T Y1 = (T)0, T Z1 = (T)0, T X2 = (T)0, T Y2 = (T)0, T Z2 = (T)0)
	{
		min.set(X1, Y1, Z1);
		max.set(X2, Y2, Z2);
	};
	...
	IC	SelfRef	set			(T xx1, T yy1, T zz1, T xx2, T yy2, T zz2)	{ min.set(xx1,yy1,zz1);max.set(xx2,yy2,zz2);	return *this;	};
	...
	IC	SelfRef	null		()								{ min.null(); max.null(); return *this; };
