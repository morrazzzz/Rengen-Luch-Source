...
public:
	void			_initialize			(const bool &dedicated,bool editor=false);
	void			_destroy			();
...
public:
	...
	on_dialog*		get_on_dialog		()							{ return m_on_dialog;	} // The callback for stuff like uncapturing mouse and keyboard and etc
