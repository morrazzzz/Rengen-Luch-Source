...
void CRenderTarget::enable_dbt_bounds(CLightSource* L)
{
	...
	u32	mask = 0xffffffff;
	EFC_Visible vis = RImplementation.baseViewFrustum_.testSphere(L->spatial.sphere.P, L->spatial.sphere.R * 1.01f, mask);
...
BOOL CRenderTarget::enable_scissor(CLightSource* L) // true if intersects near plane
{
