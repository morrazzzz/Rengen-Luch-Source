...
void CRenderTarget::accum_spot(CLightSource* L)
{
	phase_accumulator();
...
void CRenderTarget::accum_volumetric(CLightSource* L)
{
	...
	// Draw volume with projective texgen
	{
		...
		RCache.BackendRender(D3DPT_TRIANGLELIST, 0, 0, VOLUMETRIC_SLICES * 4, 0, VOLUMETRIC_SLICES * 2);
