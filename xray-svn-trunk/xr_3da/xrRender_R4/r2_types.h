...
#define		r2_RT_shader_params	"$user$shader_params" // MRT
...
//new bloom
#define	r2_RT_treshold "$user$treshold"
#define r2_RT_texBloom2 "$user$bloom_2"
#define r2_RT_texBloom3 "$user$bloom_3"

//smaa
#define		r2_RT_smaa_edgetex				"$user$edgetex"
#define		r2_RT_smaa_blendtex				"$user$blendtex"

#define     r2_RT_reflections	"$user$refl"
