...
__inline float PLC_energy_x86(Fvector& P, Fvector& N, CLightSource* L, float E)
{
	Fvector Ldir;
...
void __stdcall PLC_calc3_x86(int& c0, int& c1, int& c2, CRenderDevice& device, Fvector* P, Fvector& N, CLightSource* L, float energy, Fvector& O)
{
...
__forceinline float PLC_energy_SSE(Fvector& P, Fvector& N, CLightSource* L, float E)
{
	Fvector Ldir;
	if (L->flags.type==IRender_Light::DIRECT)
	{
...
void __stdcall PLC_calc3_SSE(int& c0, int& c1, int& c2, CRenderDevice& device, Fvector* P, Fvector& N, CLightSource* L, float energy, Fvector& O)
{
