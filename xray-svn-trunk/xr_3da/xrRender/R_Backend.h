...
public:
	...
	ICF	void						BackendRender		(D3DPRIMITIVETYPE t, u32 baseV, u32 startV, u32 countV, u32 startI, u32 PC);
	ICF	void						BackendRender		(D3DPRIMITIVETYPE t, u32 startV, u32 PC);
	...
	void							CreateQuadIB		();
	void							OnRenderBegin		(ViewPort vp);
	void							OnRenderFinish		(ViewPort vp);
	void							OnDeviceCreate		();
