...
void dxThunderboltRender::Render(CEffect_Thunderbolt &owner)
{
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, v_offset, 0, vCount_Lock, i_offset, iCount_Lock / 3);
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, VS_Offset, 0, 4, 0, 2);
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, VS_Offset + 4, 0, 4, 0, 2);
}