...
public:
	...
	void				AddSkeletonWallmark		(intrusive_ptr<CSkeletonWallmark> wm, DsGraphBuffer& buffer);
	void				AddSkeletonWallmark		(const Fmatrix* xf, CKinematics* obj, ref_shader& sh, const Fvector& start, const Fvector& dir, float size, IRenderBuffer* render_buffer);
