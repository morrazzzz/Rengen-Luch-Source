...
void dx103DFluidGrid::DrawSlices( void )
{
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, 0, m_iNumVerticesSlices / 3);
}
...
void dx103DFluidGrid::DrawSlicesToScreen( void )
{
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, 0, m_iNumVerticesRenderQuad / 3);
}
...
void dx103DFluidGrid::DrawBoundaryQuads( void )
{
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, 0, m_iNumVerticesBoundarySlices / 3);
}
...
//		stride, offset, 0, numVerticesBoundaryLines  );
	...
	RCache.BackendRender(D3DPT_TRIANGLELIST, 0, m_iNumVerticesBoundaryLines / 3);
}