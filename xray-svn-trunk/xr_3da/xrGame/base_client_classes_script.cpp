...
//			.def("shedule_Update",		&ISheduled::ScheduledUpdate,		&CISheduledWrapper::ScheduledUpdate_static)
	];
}
...
//			.def("shedule_Update",		&CObject::ScheduledUpdate,		&CObjectWrapper::ScheduledUpdate_static)
...
//			.def("shedule_Update",		&CGameObject::ScheduledUpdate,		&CGameObjectWrapper::ScheduledUpdate_static)
...
//			.def("renderable_ShadowReceive",&CGameObject::renderable_ShadowReceive,&CGameObjectWrapper::renderable_ShadowReceive_static)
			...
			.def("net_Export",			&CGameObject::ExportDataToServer,	&CGameObjectWrapper::ExportDataToServer_static)
			.def("net_Spawn",			&CGameObject::SpawnAndImportSOData,	&CGameObjectWrapper::SpawnAndImportSOData_static)
