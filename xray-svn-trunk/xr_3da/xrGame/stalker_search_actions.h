...
private:
	...
	u32					m_last_hit_time;
	bool				crouchStateUsed_;
	bool				goingToEnemyPoint_;
...
private:
	CPropertyStorage	*m_combat_storage;
	u32					m_last_hit_time;
	bool				goingToAmbushPoint_;
	bool				standStateUsed_;
...
private:
	...
	float				otherAmbushPointMinDist_;
...
public:
	...
	virtual bool	check_if_need_other_ambush_point();
};
