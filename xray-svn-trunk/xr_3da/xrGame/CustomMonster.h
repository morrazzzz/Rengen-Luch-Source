...
public:
	...
	Fmatrix				eye_matrix;
	int					eye_bone;
	float				monsterEyeFov_;
	float				monsterEyeRange_;
...
//	Fmatrix				m_tServerTransform;
	...
	// to spread workload betwean two aux threads
	u8					mtUpdateThread_;
...
public:
	virtual float				GetEyeFovValue()		const;
	virtual float				GetEyeRangeValue()		const;
