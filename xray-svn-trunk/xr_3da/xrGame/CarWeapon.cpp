...
CCarWeapon::CCarWeapon(CPhysicsShellHolder* obj)
{
	...
	LoadCfg								(pUserData->r_string("mounted_weapon_definition","wpn_section"));
	SetBoneCallbacks					();
...
void CCarWeapon::LoadCfg(LPCSTR section)
{
...
void CCarWeapon::UpdateBarrelDir()
{
	...
	m_cur_x_rot		= angle_inertion_var(m_cur_x_rot,m_tgt_x_rot,m_min_gun_speed,m_max_gun_speed,PI,TimeDelta());
	m_cur_y_rot		= angle_inertion_var(m_cur_y_rot,m_tgt_y_rot,m_min_gun_speed,m_max_gun_speed,PI,TimeDelta());
