...
void CALifeMonsterDetailPathManager::script_register	(lua_State *L)
{
	...
	[
		class_<CALifeMonsterDetailPathManager>("CALifeMonsterDetailPathManager")
			.def("target",		(bool (CALifeMonsterDetailPathManager::*)(const GameGraph::_GRAPH_ID &, const u32 &, const Fvector &))(&CALifeMonsterDetailPathManager::target))
			.def("target",		(void (CALifeMonsterDetailPathManager::*)(const GameGraph::_GRAPH_ID &))(&CALifeMonsterDetailPathManager::target))
			.def("target",		(bool (CALifeMonsterDetailPathManager::*)(const CALifeSmartTerrainTask *))(&CALifeMonsterDetailPathManager::target))
