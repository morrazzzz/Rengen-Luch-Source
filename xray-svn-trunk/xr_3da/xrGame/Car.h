...
public:
	...
	virtual BOOL			NeedDataExport				()	{ return TRUE; };			// relevant for export to server
...
IC	float	 			EngineRpmFromWheels					(){return abs(DriveWheelsMeanAngleRate()*m_current_gear_ratio);}
	/////////////////////////////////////////////////////////////////////////	
	void				SteerRight							();
	void				SteerLeft							();
	void				SteerIdle							();
