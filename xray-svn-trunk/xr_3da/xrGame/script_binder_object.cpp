...
bool CScriptBinderObject::SpawnAndImportSOData(SpawnType data_containing_so)
{
	return			(true);
}

void CScriptBinderObject::DestroyClientObj()
{
}

void CScriptBinderObject::ExportDataToServer(NET_Packet *net_packet)
{
}

void CScriptBinderObject::ScheduledUpdate	(u32 time_delta)
{
}
...
void CScriptBinderObject::RemoveLinksToCLObj(CScriptGameObject *object)
{
}
