...
//	Msg								("[%6d] m_failed_to_build_path = %s (stalker_movement_manager_obstacles::build_level_path)",EngineTimeU(),m_failed_to_build_path ? "true" : "false");
...
//	Msg								("[%6d][%6d][%s][%f] build_level_path",CurrentFrame(),EngineTimeU(),*object().ObjectName(),timer.GetElapsed_sec()*1000.f);
}
