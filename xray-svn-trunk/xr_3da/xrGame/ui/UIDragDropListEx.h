...
protected:
	...
	virtual void			UpdateHintShow();
	
public:
	IC CUICellContainer* 	GetContainer() { return m_container; };
	...
	const	Ivector2		GetVirtualCellsAlignment() {return m_virtual_cells_alignment;};
			...
			void			SetAutoGrowY		(bool b);
			bool			IsAutoGrowY			();
			void			SetAutoGrowX		(bool b);
			bool			IsAutoGrowX			();
...
public:
	...
	virtual CUICellItem*	RemoveByInvItem		(CInventoryItem* itm);
...
protected:
	...
	IC const	Ivector2&		CellsSpacing		()								{return m_cellSpacing;};	
				...
				void			Grow				(bool grow_y, bool grow_x);
				void			Shrink				();
