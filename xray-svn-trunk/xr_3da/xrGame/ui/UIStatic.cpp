...
void CUIStatic::Update()
{
	...
	if(CursorOverWindow() && m_stat_hint_text.size() && !g_statHint->Owner() && EngineTimeU()>m_dwFocusReceiveTime+700)
	{
...
{
	m_lanim_xform.m_lanim_start_time = EngineTimeU()/1000.0f;
}
