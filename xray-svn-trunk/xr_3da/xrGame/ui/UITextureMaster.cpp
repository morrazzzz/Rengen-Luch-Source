...
#pragma todo("Need to fix the way engine reports it, since sometimes it logs wrong texture path")
	...
	{ 
		...
		shared_str str2 = str;
		g_pGamePersistent->SuggestedForPrefetchingUI.push_back(str2);
	}
