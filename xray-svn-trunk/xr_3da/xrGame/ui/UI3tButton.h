...
//.			void 	SetTextColor				(u32 color);
	...
	void			SetConstTextureState		(IBState state) { if (m_background) m_background->SetConstTextureState(state); };
	void			RemoveConstTextureState		()				{ if (m_background) m_background->SetConstTextureState(IBState::S_Total); };
