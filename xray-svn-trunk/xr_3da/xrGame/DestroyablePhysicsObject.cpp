...
void CDestroyablePhysicsObject::DestroyClientObj()
{
...
BOOL CDestroyablePhysicsObject::SpawnAndImportSOData(CSE_Abstract* data_containing_so)
{
	...
	RunStartupAnim(data_containing_so);
	return res;
}
...
void CDestroyablePhysicsObject::ScheduledUpdate(u32 dt)
{
