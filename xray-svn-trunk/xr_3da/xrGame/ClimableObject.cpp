...
void CClimableObject::	LoadCfg				( LPCSTR section)
{
	inherited::LoadCfg(section);
}

BOOL CClimableObject::	SpawnAndImportSOData			( CSE_Abstract* data_containing_so)
{
...
void CClimableObject::DestroyClientObj()
{
...
void CClimableObject::ScheduledUpdate(u32 dt)// Called by shedule
{
