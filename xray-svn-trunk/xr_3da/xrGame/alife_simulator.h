...
extern CALifeSimulator* alifeSimulator_;

IC CALifeSimulator* Alife()
{
	R_ASSERT(alifeSimulator_);

	return alifeSimulator_;
};

IC bool IsAlifeInited()
{
	return (alifeSimulator_ && alifeSimulator_->initialized());
};
