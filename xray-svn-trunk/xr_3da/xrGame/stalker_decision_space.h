...
namespace StalkerDecisionSpace {
	enum EWorldProperties {
		...
		eWorldPropertyEnemyToStrong,

		eWorldPropertyEnemyLocalized,
		eWorldPropertyKnowWhereEnemy,
...
// combat
		...
		eWorldOperatorKillEnemyOnThePath,
