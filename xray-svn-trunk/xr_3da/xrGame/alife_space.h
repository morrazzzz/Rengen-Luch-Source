...
//WEATHER_CHUNK_DATA takes 0x0009, so use 0x0010
#define SHORT_GAME_INFO				0x0010
...
#define NEW_INVALID_OBJECT_ID		4294967295
...
namespace ALife {
	...
	typedef u32	_OBJECT_ID_u32;								// Object ID u32
