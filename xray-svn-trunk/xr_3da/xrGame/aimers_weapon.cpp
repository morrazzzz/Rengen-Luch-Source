...
#pragma todo("Dima to Dima: use function from weapon to get this information")
	...
	Fvector					pos,ypr;
	pos						= pSettings->r_fvector3( m_weapon.SectionName(),"position" );
	ypr						= pSettings->r_fvector3( m_weapon.SectionName(),"orientation" );
	ypr.mul					(PI/180.f);
	...
	Fvector					vLoadedFirePoint = pSettings->r_fvector3( m_weapon.SectionName(), "fire_point" );
	Fmatrix					transform;
