...
// Cop merge
// 119 cop - CSE_ALifeObjectHangingLamp		added property	m_volumetric_quality
//										added property	m_volumetric_intensity
//										added property	m_volumetric_distance
// 120 cop - CSE_SmartCover					added property	m_enter_min_enemy_distance
//										added property	m_exit_min_enemy_distance
// 121 cop - GameTypeChooser				m_gameType using instead og u8 value;
// 122 cop - CSE_ALifeItemWeapon			appended with count of grenades to spawn in grenade launcher (if it attached)
// 123 cop - CSE_ALifeInventoryItem			added functions has_upgrade & add_upgrade, xr_vector<shared_str> m_upgrades
...
// 150 - A lot of stuff has been changed from 082016 up till now 062018. Need to separate it
// 151 - Some stuff from anomaly classes is now removed from netpackets and read in cfg
//------------------------------------------------------------------------------
#define SPAWN_VERSION	u16(160)
#define COPRL u16(160) // temp