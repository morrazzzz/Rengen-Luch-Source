...
bool IsForGameSave()
{
	...
	return true; // If it is game save
#elif XRSE_FACTORY_EXPORTS
	return isCpmpilingSpawn_; // If it if se server, and it is compiling data for xrAI spawn compilation
#else
	return false;
#endif
}
