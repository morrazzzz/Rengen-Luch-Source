...
void CDialogScriptHelper::AddHasAnyInfo(LPCSTR str)
{
	m_HasAnyInfo.push_back(str);
}
void CDialogScriptHelper::AddDontHasAnyInfo(LPCSTR str)
{
	m_DontHaveAnyInfo.push_back(str);
}
...
void CPhraseDialogExporter::script_register(lua_State *L)
{
	...
	[
		...
		.def("AddHasAnyInfo",		&CDialogScriptHelper::AddHasAnyInfo)
		.def("AddDontHasAnyInfo",	&CDialogScriptHelper::AddDontHasAnyInfo)
