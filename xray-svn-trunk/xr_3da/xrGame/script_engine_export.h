...
#pragma note("Include the header of your new client class here, or it will not be exported for scripts(Unles intended to not export)")
...
#	include "../../xrSE_Factory/script_properties_list_helper.h"
#else
