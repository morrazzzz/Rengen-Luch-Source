...
private:
	...
	bool						isReadyToExpload_;
	Fvector						exploadPos_;
	Fvector						exploadNormal_;
public:
								CExplosive(void);
...
protected:
			bool				IsSoundPlaying			(){return sndExplode._feedback() != nullptr || (hasDistExplodeSnd_ && sndExplodeDist._feedback() != nullptr);}
...
protected:
	...
	ref_sound					sndExplodeDist;
	ESoundTypes					m_eSoundExplode;

	bool						hasDistExplodeSnd_;
