...
struct SCharacterProfile : CSharedResource
{
	...
	CHARACTER_RANK_VALUE			characterProfileRank_;
...
public:
	...
	IC const CHARACTER_RANK&	GetCharacterRank()	const	{ return characterCurrentRank_; };
...
protected:
	void						SetCharacterRank	(CHARACTER_RANK_VALUE			rank);
	void						SetReputation		(CHARACTER_REPUTATION_VALUE		reputation);
	void						SetCommunity		(const CHARACTER_COMMUNITY_INDEX&community)
	{
...
#ifdef XRGAME_EXPORTS
	CHARACTER_RANK					characterCurrentRank_;
	CHARACTER_REPUTATION			m_CurrentReputation;
	CHARACTER_COMMUNITY				m_CurrentCommunity;
	float							m_Sympathy; // % пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ
#endif
};