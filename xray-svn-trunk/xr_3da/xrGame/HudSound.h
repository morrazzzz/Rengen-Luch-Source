...
struct HUD_SOUND_ITEM
{
	...
	static SSnd*	PlaySound		(HUD_SOUND_ITEM& snd,
	...
	static u8		GetFreeSoundInd	(HUD_SOUND_ITEM& hud_snd);
...
public:
	...
	void						StopAllSounds	(LPCSTR exept_these = nullptr);
};
