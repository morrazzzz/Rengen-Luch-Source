...
struct SBinocVisibleObj{
	...
	float					m_upd_speed;
	float					displayRadius_; // Radius from center of the screen in which the detection is displayed
...
protected :
	...
	float						screenRadius_; // Radius from center of the screen in which the detection is displayed
