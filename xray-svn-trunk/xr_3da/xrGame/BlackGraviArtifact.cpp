...
void CBlackGraviArtefact::LoadCfg(LPCSTR section) 
{
...
BOOL CBlackGraviArtefact::SpawnAndImportSOData(CSE_Abstract* data_containing_so)
{
...
void CBlackGraviArtefact::RemoveLinksToCLObj(CObject* O)
{
