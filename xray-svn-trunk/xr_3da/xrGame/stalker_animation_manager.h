...
private:
			float					legs_switch_factor		() const;
...
public:
			...
			bool					non_script_need_update	() const;
...
private:
			void					play_script_impl		();
			bool 					play_script				();

private:
			void					play_global_impl		(const MotionID &animation, bool const &animation_movement_controller);
			bool 					play_global				();
