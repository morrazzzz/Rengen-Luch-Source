...
private:
	SOUND_COLLECTIONS							m_sound_collections;
...
public:
	...
	virtual	void		reload						(LPCSTR section);
			void		unload						();
			u32			add							(bool in_aux_thread, LPCSTR prefix, u32 max_count, ESoundTypes type, u32 priority, u32 mask, u32 internal_type, LPCSTR bone_name, CSound_UserDataPtr data = 0);
	void	__stdcall	add_new						(CSoundCollectionParamsFull sound_params, u32 internal_type, u32 returned_sounds_size);
	...
	IC	const SOUND_COLLECTIONS &sound_collections() const;
	...
	Mutex npc_sound_pool_protect; //protect m_sound_collections from access races by several threads
