...
bool CSE_ALifeOnlineOfflineGroup::NeedServerUpdates		(CSE_ALifeDynamicObject *object)
{
	return true;
}
...
void CSE_ALifeOnlineOfflineGroup::try_switch_online		()
{
	...
	MEMBERS::iterator			E = m_members.end();
	for ( ; I != E; ++I) {
		R_ASSERT3				((*I).second->g_Alive(),"Incorrect situation : some of the OnlineOffline group members is dead",(*I).second->name_replace());
		R_ASSERT3				((*I).second->can_switch_online(), "Incorrect situation : some of the OnlineOffline group members cannot be switched online due to their personal properties", (*I).second->name_replace());
		R_ASSERT3				((*I).second->can_switch_offline(), "Incorrect situation : some of the OnlineOffline group members cannot be switched online due to their personal properties", (*I).second->name_replace());
