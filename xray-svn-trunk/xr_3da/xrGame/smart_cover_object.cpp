...
void object::LoadCfg			(LPCSTR section)
{
...
BOOL object::SpawnAndImportSOData		(CSE_Abstract *data_containing_so)
{
	CSE_SmartCover					*smart_cover = smart_cast<CSE_SmartCover*>(data_containing_so);
	VERIFY							(smart_cover);
...
void object::ScheduledUpdate	(u32 dt)
{
	NODEFAULT;
}
