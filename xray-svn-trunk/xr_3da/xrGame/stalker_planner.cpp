...
void CStalkerPlanner::add_evaluators()
{
	...
	add_evaluator			(eWorldPropertyEnemy			, xr_new <CStalkerPropertyEvaluatorEnemies>(m_object, "is_there_enemies", false, CStalkerCombatPlanner::POST_COMBAT_WAIT_INTERVAL));
