...
void CSE_ALifeEatableItem::script_register(lua_State *L)
{
	module(L)[
		...
		.def("se_get_portions_num", &CSE_ALifeEatableItem::se_get_portions_num)
		.def("se_set_portions_num", &CSE_ALifeEatableItem::se_set_portions_num)
		.def("se_get_initial_portions_num", &CSE_ALifeEatableItem::se_get_initial_portions_num)
	];
}
