...
public:
	...
	IC		void			set_destroy_time		(u32 delta_destroy_time) {m_dwDestroyTime = delta_destroy_time + EngineTimeU();}
...
public:
	...
	IC		int				time_from_begin_throw	() const { return (EngineTimeU() + m_dwDestroyTimeMax - m_dwDestroyTime); }
