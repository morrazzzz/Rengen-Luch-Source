...
void CAI_PseudoDog::LoadCfg(LPCSTR section)
{
...
void CAI_PseudoDog::reload(LPCSTR section)
{
	...
	sound().add					(true, pSettings->r_string(section,"sound_psy_attack"), DEFAULT_SAMPLE_COUNT,	SOUND_TYPE_MONSTER_ATTACKING,	MonsterSound::eHighPriority+3,	MonsterSound::eBaseChannel,	ePsyAttack, "bip01_head");
