...
void CPsyDog::LoadCfg(LPCSTR section)
{
...
BOOL CPsyDog::SpawnAndImportSOData(CSE_Abstract* data_containing_so)
{
...
BOOL CPsyDogPhantom::SpawnAndImportSOData(CSE_Abstract *data_containing_so)
{
	if (!inherited::SpawnAndImportSOData(data_containing_so))
		return FALSE;

	CSE_ALifeMonsterBase *se_monster	= smart_cast<CSE_ALifeMonsterBase*>(data_containing_so);
	...
	load_effector(*SectionName(), "appear_effector",m_appear_effector);
	
	// --------------------------------------------------------------------------------
	m_particles_appear		= pSettings->r_string(*SectionName(), "particles_appear");
	m_particles_disappear	= pSettings->r_string(*SectionName(), "particles_disappear");
...
void CPsyDogPhantom::DestroyClientObj()
{
	Fvector center;
	Center(center);
