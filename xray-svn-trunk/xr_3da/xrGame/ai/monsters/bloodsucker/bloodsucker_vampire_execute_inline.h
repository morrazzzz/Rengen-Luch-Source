...
void CStateBloodsuckerVampireExecuteAbstract::initialize()
{
	...
	CurrentGameUI()->ShowGameIndicators(IB_BLOODSUCKER_ATTACK, false);
	CurrentGameUI()->ShowCrosshair(CB_BLOODSUCKER_ATTACK, false);
	CurrentGameUI()->AllowInput(GINPUT_BLOODSUCKER_ATTACK, false);
...
{
	CurrentGameUI()->ShowGameIndicators(IB_BLOODSUCKER_ATTACK, true);
	CurrentGameUI()->ShowCrosshair(CB_BLOODSUCKER_ATTACK, true);
	CurrentGameUI()->AllowInput(GINPUT_BLOODSUCKER_ATTACK, true);
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_prepare()
{
	...
	time_vampire_started				= EngineTimeU();
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_continue()
{
	...
	if (time_vampire_started + VAMPIRE_TIME_HOLD < EngineTimeU()) {
