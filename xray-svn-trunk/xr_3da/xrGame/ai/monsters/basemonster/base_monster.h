...
public:
	...
	virtual void			OnHUDDraw						(CCustomHUD* hud, IRenderBuffer& render_buffer)			{return inherited::OnHUDDraw(hud, render_buffer);}
	...
	virtual void			renderable_Render				(IRenderBuffer& render_buffer)							{return inherited::renderable_Render(render_buffer);} 
	...
	IC		int				GetMonsterRank					(){return monsterRank_;}
...
public:
	...
	virtual	char*			get_monster_class_name	() { return "not overriden"; };
