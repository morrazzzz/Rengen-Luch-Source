...
enum EMonsterState {
	...
	eStateGhostBossScanning				= eStateCustom | 7,
	eStateGhostBossAttack_Shield		= eStateCustom | 8,
	...
	eStateGhostBossAttack_Tele		= eStateCustom | eStateAttack | 17,
	eStateGhostBossAttack_Gravi		= eStateCustom | eStateAttack | 18,
	eStateGhostBossAttack_RunAround	= eStateCustom | eStateAttack | 19,
	eStateGhostBossAttack_FaceEnemy	= eStateCustom | eStateAttack | 20,
	eStateGhostBossAttack_Melee		= eStateCustom | eStateAttack | 21,
	eStateGhostBossAttack_Teleport	= eStateCustom | eStateAttack | 22,

	eStateCustom_Choke				= eStateCustom | eStateAttack | 23,
	eStateChoke_Execute				= eStateCustom | eStateAttack | 24,
	// -------------------------------------------------------------
