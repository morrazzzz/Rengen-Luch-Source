...
void CPseudoGigant::LoadCfg(LPCSTR section)
{
...
void CPseudoGigant::reinit()
{
	...
	move().load_velocity(*SectionName(), "Velocity_JumpPrepare",MonsterMovement::eGiantVelocityParameterJumpPrepare);
	move().load_velocity(*SectionName(), "Velocity_JumpGround",MonsterMovement::eGiantVelocityParameterJumpGround);
