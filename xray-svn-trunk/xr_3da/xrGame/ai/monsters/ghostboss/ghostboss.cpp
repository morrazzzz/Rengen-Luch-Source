...
void CGhostBoss::DestroyClientObj()
{
...
void CGhostBoss::LoadCfg(LPCSTR section)
{
...
void CGhostBoss::ScheduledUpdate(u32 dt)
{
...
void CGhostBoss::UpdateCL()
{
	...
	inherited::UpdateCL();
	TScanner::frame_update(TimeDeltaU());
...
{
	if (m_shield_active && (pHDS->hit_type == ALife::eHitTypeFireWound) && (CurrentFrame() != last_hit_frame)) {
...
void CGhostBoss::RemoveLinksToCLObj(CObject *O)
{
