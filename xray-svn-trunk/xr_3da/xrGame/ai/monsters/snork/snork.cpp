...
#pragma todo("Cop merge: Check skyloader commit '1. Changed schemes of monsters'. Probably need to return drag corpuses scheme")
#pragma todo("Cop merge: Check ghost commit 'Added class Karlic")
...
void CSnork::LoadCfg(LPCSTR section)
{
...
void CSnork::reinit()
{
	...
	move().load_velocity(*SectionName(), "Velocity_JumpGround",MonsterMovement::eSnorkVelocityParameterJumpGround);
