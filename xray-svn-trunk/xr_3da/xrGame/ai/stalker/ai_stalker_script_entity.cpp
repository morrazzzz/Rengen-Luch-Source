...
u32 CAI_Stalker::GetWeaponAmmo() const
{
	...
	return((u32)GetCurrentWeapon()->GetSuitableAmmoTotal(true));	
}
...
bool CAI_Stalker::bfAssignObject(CScriptEntityAction* tpEntityAction)
{
	...
	switch (l_tObjectAction.m_tGoalType)
	{
		...
		case eObjectActionTake : {
			if (inventory().GetItemBySect(l_tObjectAction.m_tpObject->SectionNameStr(), inventory().allContainer_))
			{
