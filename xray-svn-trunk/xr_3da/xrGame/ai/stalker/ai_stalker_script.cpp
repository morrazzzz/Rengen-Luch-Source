	...
	[
		class_<CStalkerPlanner>("stalker_ids")
			...
			[
				...
				luabind::value("property_enemy_localized",					StalkerDecisionSpace::eWorldPropertyEnemyLocalized),
				luabind::value("property_know_where_enemy",					StalkerDecisionSpace::eWorldPropertyKnowWhereEnemy),
				luabind::value("property_panic",							StalkerDecisionSpace::eWorldPropertyPanic),
				luabind::value("property_enemy_to_strong",					StalkerDecisionSpace::eWorldPropertyEnemyToStrong),
			...
			[
				...
				luabind::value("action_kill_enemy_on_the_path",				StalkerDecisionSpace::eWorldOperatorKillEnemyOnThePath),
				...
				luabind::value("action_reach_firing_distance",				StalkerDecisionSpace::eWorldOperatorReachFireDist),
