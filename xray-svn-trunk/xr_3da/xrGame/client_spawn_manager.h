...
protected:
			void		remove_spawn_callback	(REQUESTED_REGISTRY &registry, ALife::_OBJECT_ID requesting_id, ALife::_OBJECT_ID requested_id, bool no_warning = false);
...
public:
	...
	virtual				~CClientSpawnManager	();
			void		add_spawn_callback		(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, const luabind::functor<void> &functor, const luabind::object &object);
			void		add_spawn_callback		(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, const luabind::functor<void> &lua_function);
			void		add_spawn_callback		(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, const CALLBACK_TYPE &object_callback);
			void		add_spawn_callback		(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id, CSpawnCallback &callback);
			void		remove_spawn_callback	(ALife::_OBJECT_ID	requesting_id, ALife::_OBJECT_ID requested_id);
