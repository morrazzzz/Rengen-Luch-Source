...
void CObjectFactory::register_classes	()
{
	...
	// Detectors
	ADD(CSimpleAnomDetector		,CSE_ALifeItemDetector			,CLSID_DETECTOR_SIMPLE			,"device_detector_simple");

	ADD(CSimpleArtDetector		,CSE_ALifeItemDetector			,CLSID_AF_DET_SIMPLE			,"af_detector_simple");
	ADD(CAdvArtDetector			,CSE_ALifeItemDetector			,CLSID_AF_DET_ADV				,"af_detector_adv");
	ADD(CEliteArtDetector		,CSE_ALifeItemDetector			,CLSID_AF_DET_ELITE				,"af_detector_elite");
	ADD(CScientificArtDetector	,CSE_ALifeItemDetector			,CLSID_AF_DET_SC				,"af_detector_scientific");


	// Devices
	ADD(CTorch					,CSE_ALifeItemTorch				,CLSID_DEVICE_TORCH				,"device_torch");
	ADD(CNightVisionDevice		,CSE_ALifeItem					,CLSID_DEVICE_NVDEVICE			,"night_vision_device");
