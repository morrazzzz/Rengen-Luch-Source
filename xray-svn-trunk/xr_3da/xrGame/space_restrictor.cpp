...
BOOL CSpaceRestrictor::SpawnAndImportSOData(CSE_Abstract* data_containing_so)
{
	actual							(false);
...
void CSpaceRestrictor::DestroyClientObj()
{
...
void CSpaceRestrictor::spatial_move_intern()
{
