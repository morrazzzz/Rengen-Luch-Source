...
// Tuning interface
extern "C" {
	typedef void __cdecl VTPause	();
	typedef void __cdecl VTResume	();
};
...
private:
	...
	bool				xrGameModuleExist;
	bool				xrRenderModuleExist;
public:
	...
	bool				XrGameModuleExist	() { return xrGameModuleExist; };
	bool				XrRenderModuleExist	() { return xrRenderModuleExist; };
